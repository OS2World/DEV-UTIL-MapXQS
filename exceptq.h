/******************************************************************************
 *
 *  exceptq.h - exceptq public header - v7.12
 *
...
#   define XQ_HMOD                     void*
# else
#   define XQ_LOADDLL(name, hndl)      (DosLoadModule(0, 0, name, &hndl) == 0)
#   define XQ_GETPROC(hndl, sym, ptr)  (DosQueryProcAddr(hndl, 0, sym, (PFN*)&ptr) == 0)
...
#else
#if defined(INCL_LIBLOADEXCEPTQ)
